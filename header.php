...
<head>
	...
	<!-- Stylesheets -->
		<!-- Bootstrap -->
			<link href="http://kokakolako.de/wp-content/themes/kokakolako/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
		<!-- Fallback.css -->
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
						<ul class="nav">
							<li><div class="navbar-logo" onclick="window.location.href=window.location.href"></div></li>
	...
	<a href="http://kokakolako.de">
		<header class="header">	
				...
				<small>
					<a href="#" onclick="kokakolako.mailto()">Kontakt/Linktipp</a>
					<a href="http://kokakolako.de/feed/">RSS-Feed</a>
				</small>
		</header>
	</a>